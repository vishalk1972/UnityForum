...
const Layout=async(
    ...
    return <div className="sm:container max-w-7xl h-full pt-12">
        <div>
                ...
                <div className="hidden md:block overflow-hidden h-fit rounded-lg border border-gray-200 order-first md:order-last ">
...

                    {
                        subreddit.creatorId!==session?.user.id ?(
                            <SubscribeLeaveToggle subredditId={subreddit.id} subredditName={subreddit.name} isSubscribed={isSubsribed}/>
                        ):null
                    }
